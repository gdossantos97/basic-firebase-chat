(function () {
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyB3G6ndsmc2fdR-O6SzamJIx5vjL1iUIZM",
    authDomain: "fir-chat-a4836.firebaseapp.com",
    databaseURL: "https://fir-chat-a4836-default-rtdb.firebaseio.com",
    projectId: "fir-chat-a4836",
    storageBucket: "fir-chat-a4836.appspot.com",
    messagingSenderId: "1059403057228",
    appId: "1:1059403057228:web:0efcc140d5e97685df0ce9"
  };
  // Initialize Firebase
  ...
  const userNameDisplay = document.getElementById('loggedInStatus'); // element that can show the current user's email
  ...
  function updateCurrentUser(userEmail) {
    if (userEmail) {
      ...
      userNameDisplay.innerText = `You are logged in using the following email: ${userEmail}`;
    } 
  }
